    ...
    <div class="row align-items-center h-100">
        <div class="col-6 mx-auto">
            ...
            <div class="text-center">
                <a href="{{ url('email/verification-notification') }}"><button type="button" class="btn btn-primary"><i class='bx bx-revision'></i> <?= get_label('resend_verification_link', 'Resend verification link') ?></button></a>
            </div>
        </div>
    </div>
</div>
