...
<div class="messenger">
    ...
    <div class="messenger-messagingView">
        ...
        <div class="m-header m-header-messaging">
            ...
            <?= get_label('chat_settings_not_set', 'Important settings for the chat feature are not set.') ?> <a href="{{ url('settings/pusher') }}"><?= get_label('click_to_configure', 'Click here to configure them now.') ?></a>
            </div>
            @endif
            @endrole
        </div>
