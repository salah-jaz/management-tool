                        ...
                        <tbody>
                            <tr style="height: 77.0938px;">
                                <td
                                    ...
                                    <span style="font-size: 18px;">{COMPANY_LOGO}</span></td>
                            </tr>
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    <p
                                                        ...
                                                        The recurring task <strong> #{TASK_ID} - "{TASK_TITLE}"</strong> has been executed. You can view the new instance here: {TASK_URL}. </p>
                                                    <table
                                                            ...
                                                            <tr>
                                                                <td
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        If you're having trouble clicking the "View Task
                                                                        Details" button, copy and paste the URL below
                                                                        into your web browser: {TASK_URL}</p>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
